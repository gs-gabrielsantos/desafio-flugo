                        ...
                        <AppSelectField
                            ...
                            options={
                                managerCandidates.length === 0
                                    ? [{ value: "", label: "Nenhum usuário com level Gestor", disabled: true } as any]
                ...
                >
                    ...
                    >
                        ...
                        <Typography sx={{ fontWeight: 700, color: "#6B7280" }}>
                            Selecionados: {form.employeeIds.length}
                        </Typography>
                    </Box>
